...
const headerView = props => {
    ...
    if(typeof(props.user) === "object")
        content = [
                <Link key="1_perf" className="bold rifle-green-text" to="/orders">Mis Pedidos</Link>,
                ...
                <a key="4_cer" className="bold rifle-green-text" href="#!" onClick={props.logout}>Cerrar sesión</a>
            ];
